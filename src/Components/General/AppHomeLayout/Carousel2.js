...
import Carousel2 from 'react-leaf-carousel';
...
const imagesBottomCarousel = [
     ...
     {
         src:`https://farehamshopping.com/wp-content/uploads/2020/03/Holland-Barrett.pn`
        },
     {
     ...
     {
         src:`https://1000logos.net/wp-content/uploads/2017/09/symbol-Waitrose.jpg`
        },
    {
        src:`https://logos-download.com/wp-content/uploads/2016/05/Iceland_logo_wordmark.png`
        },
   
    {
        src:`https://www.corerfid.com/wp-content/uploads/2017/06/ocado-logo-news-item.png`
        },
    {
